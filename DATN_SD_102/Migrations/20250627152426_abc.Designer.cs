            ...
            modelBuilder.Entity("F4_API.Models.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhatCuoiCung = new DateTime(2025, 6, 27, 22, 24, 25, 272, DateTimeKind.Local).AddTicks(4742),
                            NgaySinh = new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2025, 6, 27, 22, 24, 25, 272, DateTimeKind.Local).AddTicks(4742),
                            Sdt = "0987654321",
            ...
            modelBuilder.Entity("F4_API.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TaiKhoanId = new Guid("99999999-9999-9999-9999-999999999999"),
                            NgayTaoTaiKhoan = new DateTime(2025, 6, 27, 22, 24, 25, 272, DateTimeKind.Local).AddTicks(4701),
                            Password = "admin123",
                            Username = "admin"
                        });
                });
