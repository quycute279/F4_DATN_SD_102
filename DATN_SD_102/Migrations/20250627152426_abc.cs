    ...
    public partial class abc : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("99999999-9999-9999-9999-999999999999"), new DateTime(2025, 6, 27, 22, 24, 25, 272, DateTimeKind.Local).AddTicks(4701), "admin123", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("88888888-8888-8888-8888-888888888888"), new Guid("11111111-1111-1111-1111-111111111111"), "Tòa nhà FPT Polytechnic, phố Trịnh Văn Bô, phường Phương Canh, quận Nam Từ Liêm, TP. Hà Nội", "admin@shop.com", false, "Nguyễn Văn Quản Trị", new DateTime(2025, 6, 27, 22, 24, 25, 272, DateTimeKind.Local).AddTicks(4742), new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 6, 27, 22, 24, 25, 272, DateTimeKind.Local).AddTicks(4742), "0987654321", new Guid("99999999-9999-9999-9999-999999999999"), true });
