            ...
            modelBuilder.Entity("F4_API.Models.NhanVien", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NgayCapNhatCuoiCung = new DateTime(2025, 7, 1, 20, 58, 18, 443, DateTimeKind.Local).AddTicks(1740),
                            NgaySinh = new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            NgayTao = new DateTime(2025, 7, 1, 20, 58, 18, 443, DateTimeKind.Local).AddTicks(1738),
                            Sdt = "0987654321",
            ...
            modelBuilder.Entity("F4_API.Models.TaiKhoan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            TaiKhoanId = new Guid("99999999-9999-9999-9999-999999999999"),
                            NgayTaoTaiKhoan = new DateTime(2025, 7, 1, 20, 58, 18, 443, DateTimeKind.Local).AddTicks(1503),
                            Password = "admin123",
                            Username = "admin"
                        });
                });
