...
{
    /// <inheritdoc />
    public partial class hieuuuu : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0000-000000000001"), "Trung tâm xử lý dữ liệu chính của máy tính.", "CPU (Vi xử lý)" },
                    { new Guid("00000000-0000-0000-0000-000000000002"), "Kết nối các linh kiện lại với nhau, cung cấp nguồn và tín hiệu.", "Mainboard (Bo mạch chủ)" },
                    { new Guid("00000000-0000-0000-0000-000000000003"), "Lưu trữ dữ liệu tạm thời khi máy hoạt động, càng nhiều RAM thì xử lý đa nhiệm càng tốt.", "RAM (Bộ nhớ tạm)" },
                    { new Guid("00000000-0000-0000-0000-000000000004"), "Lưu trữ hệ điều hành, phần mềm, dữ liệu người dùng.", "Ổ cứng (SSD/HDD)" },
                    { new Guid("00000000-0000-0000-0000-000000000005"), "Cung cấp điện năng cho toàn bộ hệ thống.", "Nguồn (PSU)" },
                    { new Guid("00000000-0000-0000-0000-000000000006"), "Bảo vệ linh kiện, hỗ trợ tản nhiệt, định hình hệ thống.", "Case (Vỏ máy tính)" },
                    { new Guid("00000000-0000-0000-0000-000000000007"), "Dùng cho xử lý đồ họa, gaming, thiết kế, dựng phim. Một số CPU đã tích hợp GPU sẵn.", "Card đồ họa (GPU)" },
                    { new Guid("00000000-0000-0000-0000-000000000008"), "Có thể là tản nhiệt khí hoặc nước, dùng cho CPU hoặc cả hệ thống.", "Tản nhiệt (Cooling)" }
                });

            migrationBuilder.InsertData(
                table: "TaiKhoans",
                columns: new[] { "TaiKhoanId", "NgayTaoTaiKhoan", "Password", "Username" },
                values: new object[] { new Guid("99999999-9999-9999-9999-999999999999"), new DateTime(2025, 7, 2, 23, 13, 21, 668, DateTimeKind.Local).AddTicks(6567), "admin123", "admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("88888888-8888-8888-8888-888888888888"), new Guid("11111111-1111-1111-1111-111111111111"), "Tòa nhà FPT Polytechnic, phố Trịnh Văn Bô, phường Phương Canh, quận Nam Từ Liêm, TP. Hà Nội", "admin@shop.com", false, "Nguyễn Văn Quản Trị", new DateTime(2025, 7, 2, 23, 13, 21, 668, DateTimeKind.Local).AddTicks(6606), new DateTime(1995, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2025, 7, 2, 23, 13, 21, 668, DateTimeKind.Local).AddTicks(6605), "0987654321", new Guid("99999999-9999-9999-9999-999999999999"), true });
